...
export default class SliderRange extends Component { 
    ...
    componentDidMount() {
        this.setState({
            cursorToLeft: this.root.offsetWidth - this.cursorWidth,
            stepWidth: (this.root.offsetWidth - (this.cursorWidth * 2)) / this.state.steps,
            trackWidth: this.root.offsetWidth - this.cursorWidth
        });
    }
